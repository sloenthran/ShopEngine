	...
	if($Core->CheckAdmin())
	{
		...
		if($Pages != 0)
		{
			...
			if($Number == 0)
			{
				...
				$Button .= '<a href="admin_logs_cash.html"><button class="przycisk"><i class="fa fa-arrow-left"></i></button></a>&nbsp;&nbsp;&nbsp;';
			...
			else
			{
				...
				$Button .= '<a href="admin_logs_cash-'.$Number.'.html"><button class="przycisk"><i class="fa fa-arrow-left"></i></button></a>&nbsp;&nbsp;&nbsp;';
		...
		if($Pages != $PagesNumber)
		{
			...
			$Button .= '<a href="admin_logs_cash-'.$Number.'.html"><button class="przycisk"><i class="fa fa-arrow-right"></i></button></a>&nbsp;&nbsp;&nbsp;';
	
		}
	
		$Button .= '<a href="admin_logs_cash-'.$PagesNumber.'.html"><button class="przycisk">'.$PagesNumber.'</button></a>';
